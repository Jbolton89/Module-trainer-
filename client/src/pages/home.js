...
import { FaBiohazard, FaFlask, FaRadiation, FaBookOpen, FaAppleAlt } from "react-icons/fa";
    ...
    return ( 
        <div className='bg-gradient-to-b from-blue-600 to-blue-900'>
                <div>
                  ...
                  <p className="mt-4 text-lg leading-relaxed text-blue-900-bold">
                    Think you are pretty bright huh? Why dont' you put your brain to the test.
                    Come on down and have a brain training session with your old mate Jason. 
                  </p>
