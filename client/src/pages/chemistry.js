...
import PhysicsPDF from "../images/chemistry.pdf";
                ...
                <div className="flex justify-center py-4 lg:pt-4 pt-8">
                  ...
                  <div className="p-3 text-center">
                    <div className="text-xl font-bold block uppercase tracking-wide text-gray-700 flex flex-col">
                      <span className="text-4xl font-semibold inline-block py-5 px-5 uppercase rounded-full text-white bg-yellow-700 mr-10">
                        <FaFlask />
                      </span>
                      Chemistry
                    </div>
